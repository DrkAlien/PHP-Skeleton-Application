                                ...
                                <table class="table table-vcenter card-table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-muted" >
                                                <?php echo (isset($user->userPlan))? $user->userPlan->label.' ($'.$user->userPlan->price.')':'n\a' ?>
                                            </td>
                                            <td class="text-muted" >
                                                <?php if($user['active']) { ?>
                                            ...
                                            <td>
                                                <a href="<?php echo $this->getControllerUrl() ?>/edit/<?php echo $user['id'] ?>">
                                            ...
                                            <td>
                                                <a href="<?php echo $this->getControllerUrl() ?>/delete/<?php echo $user['id'] ?>">
