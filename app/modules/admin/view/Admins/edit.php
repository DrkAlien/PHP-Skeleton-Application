            ...
            <div class="container-xl">
                ...
                <div class="row row-cards">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                            ...
                            <form action="<?php echo $this->getControllerUrl() ?>/update/<?php echo $this->data['admin']['id'] ?>" method="post" class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <input type="text" name="first_name" value="<?php echo (isset($this->data['admin']['first_name']))? $this->data['admin']['first_name']:'' ?>" class="form-control" placeholder="First Name">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            <label class="form-label col-3 col-form-label">Last Name</label>
                                            <div class="col">
                                                <input type="text" name="last_name" value="<?php echo (isset($this->data['admin']['last_name']))? $this->data['admin']['last_name']:'' ?>" class="form-control"  placeholder="Last Name">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            <label class="form-label col-3 col-form-label">Email address</label>
                                            <div class="col">
                                                <input type="email" name="email" value="<?php echo (isset($this->data['admin']['email']))? $this->data['admin']['email']:'' ?>" class="form-control"  placeholder="Enter email">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 row">
                                            ...
                                            <div class="col">
                                                <label class="">
                                                    <label class="form-colorinput">
                                                        <input name="active" type="checkbox" <?php echo ($this->data['admin']['active'])? 'checked=""':'' ?> class="form-colorinput-input">
